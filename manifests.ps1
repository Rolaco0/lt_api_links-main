...
function Write-Header {
    ...
    $discordLink = "$esc]8;;https://discord.gg/ZbrzCC8HaK$esc\discord.gg/ZbrzCC8HaK$esc]8;;$esc\"
...
if ($resolvedMode -eq "github") {
    ...
    if (-not $activeApiKey) {
        ...
        Write-Host "    3. Or get it from RolacoTools plugin settings if you set it there" -ForegroundColor DarkGray
        Write-Host ""
